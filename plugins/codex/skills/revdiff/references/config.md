...
| `--plain-annotations` | `REVDIFF_PLAIN_ANNOTATIONS` | Render annotation bodies as plain italic text instead of glow-style markdown (bold, inline code, fenced code blocks) | `false` |
