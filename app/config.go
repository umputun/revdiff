...
type options struct {
	...
	AllChanges       bool     `long:"all-changes" ini-name:"all-changes" env:"REVDIFF_ALL_CHANGES" description:"show staged, unstaged, and untracked as separate groups (git only)"`
