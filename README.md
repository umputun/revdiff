...
- Vertical scrollbar thumb: a thicker `┃` segment on the diff pane's right border indicates the visible portion of long files; thumb size and position track scroll progress automatically
